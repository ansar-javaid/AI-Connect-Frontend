...
export default function CreatedScreen({navigation}) {
  return (
    <View style={styles.container}>
      ...
      <View>
        <TouchableOpacity>
               <Image source={require('../assets/notification.png')} style={styles.ntfcnbtn} />
               </TouchableOpacity>
      ...
      <Image source={require('../assets/tick.png')} style={{position:'absolute', alignSelf:'center', top:450}}  />
      <Image source={require('../assets/circle.png')} style={{position:'absolute', alignSelf:'center', top:425}}  />
      <Text style={styles.success}>Created Succesfully</Text>
