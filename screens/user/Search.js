...
const Search = () => {
    ...
    const renderItem = ({ item }) => {
        ...
        const navigateToProfile = async () => {
            ...
            navigation.navigate("ProfileScreen", { profileId: item.profileID, email: email, profileTitle: item.profileTitle, profilePicture: item.path, profileDescription: item.profileDescription });
        };
