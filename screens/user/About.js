  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={[styles.content]}>
        Welcome to Cu-Connect, the social media app designed exclusively for
        university students! Our team is excited to offer a platform where
        students can connect with each other. {"\n"}
        We understand that university can be a challenging and sometimes
        overwhelming experience, which is why we created Cu-Connect as a way to
        support and empower students.{"\n"}
        Our team is made up of passionate and dedicated individuals who are
        committed to helping students thrive. We are constantly working to
        improve our app and to ensure that it meets the evolving needs of our
        users.
        {"\n"}Thank you for choosing Cu-Connect as your go-to social media app
        for university. We are proud to be part of your journey, and we look
