...
export default function ProfileScreen1({ route, navigation }) {
    ...
    const { profileId, email, profileTitle, profilePicture, profileDescription } = route.params;
    ...
    useFocusEffect(
        React.useCallback(() => {
            ...
            getInitialProfileData();
            setStatus(false);
            console.log(profileId + email, +profileTitle, profilePicture, profileDescription);
        }, [])
    );
                    ...
                    <View style={{ flex: 1 }}>
                        ...
                        <View style={{ flexDirection: "row" }}>
                            <TouchableOpacity onPress={() => setShowModal(true)}>
                                <Image source={{ uri: profilePicture }} style={styles.depicon} />
                            </TouchableOpacity>
