  ...
  return (
    <View style={styles.container}>
      <View style={styles.postbox}>
        ...
        >
          <Image
            source={require("../assets/depIcon.png")}
            style={{ margin: 10 }}
          />
          <Text style={{ fontSize: 15, fontWeight: "600", color: "#242424" }}>
            CreateProfile NAME
          </Text>
        </View>
        <View
        ...
        <TextInput
          multiline
          style={{ marginLeft: 20, width: "88%", height: "60%" }}
        ...
        >
          ...
          <TouchableOpacity onPress={() => console.log("Select Document")}>
            <LinearGradient
              start={{ x: 1, y: 0 }}
              end={{ x: 0, y: 0 }}
